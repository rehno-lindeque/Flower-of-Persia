...
public:  
  ...
  {    
    ...
    segments = 31; // this number must be odd
  
    float arches[][3] = 
    { {0.0f, 0.0f,  -8.0-colRadius},
      {0.0f, 0.0f, -16.0-colRadius},
      {0.0f, 0.0f, -24.0-colRadius} };
    ...
    glNewList(displayList, GL_COMPILE);    
      ...
      glBegin(GL_QUADS);        
        ...
        {
          // draw collumns
          extrudeYQuad(colRadius, startHeight, collumnHeight+startHeight, -gap - colRadius, arches[c][2]);
          extrudeYQuad(colRadius, startHeight, collumnHeight+startHeight,  gap + colRadius, arches[c][2]);
